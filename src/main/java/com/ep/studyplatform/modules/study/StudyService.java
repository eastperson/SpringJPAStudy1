...
import static com.ep.studyplatform.modules.study.form.StudyForm.VALID_PATH_PATTERN;
...
public class StudyService {
    ...
    private void checkIfEnrolled(Account account, Event event) {
        if(!account.isEnrollmentOf(event)) {
            throw new AccessDeniedException("해당 기능을 사용할 수 없습니다.");
        }
    }
