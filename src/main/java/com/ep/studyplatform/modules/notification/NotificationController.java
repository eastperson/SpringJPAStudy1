...
public class NotificationController {
    ...
    public String getNotificaitons(@CurrentUser Account account, Model model){
    ...
    private void putCategorizedNotifications(Model model, List<Notification> notifications, long numberOfChecked, long numberOfNotChecked) {
        ...
        for(var notification : notifications){
            switch (notification.getNotificationType()){
                ...
                case EVENT_ENROLLMENT:newStudyNotifications.add(notification); break;
                case STUDY_UPDATED:newStudyNotifications.add(notification); break;
            }
        }
